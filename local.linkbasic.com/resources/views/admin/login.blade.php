        ...
        <div class="container">
            <div class="form-outer text-center d-flex align-items-center">
                <div class="form-inner">
                    <div class="logo text-uppercase"><span>Linkbasic</span><strong class="text-primary">Admin Login</strong></div>
                    <p>------------------------------------------Company Introduction------------------------------------------</p>
                    <form method="POST" class="text-left form-validate" method="POST" action="{{ route('admin.login') }}">
                        @csrf
